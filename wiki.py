...
ADVANCED = \
  ...
  "8. Most recent articles\n" \
  "9. Check whether favorite author in list\n" \
  "10. Titles and authors only\n"\
  "11. Refine search\n" \
  "12. Article length\n" \
  "13. Key by author\n" \
  "14. Filter to author\n" \
  "15. Filter out keyword\n" \
  "16. Articles from year\n" \
  "17. None\n" \
...
ADVANCED_TO_QUESTION = {
  ...
  6: "",
  7: "What's the max article length (in number of characters) you're looking for? ",
  8: "What's the max number of unique authors you would like? ",
  9: "",
  10: "Who's your favorite author? ",
  11: "",
  12: "What's the other keyword you would like to search for? ",
  13: "", 
  14: "What's the max article length (in number of characters) you're looking for? ",
  15: "",
  16: "Which author would like to filter to? ",
  17: "What keyword would you like to exclude from your search? ",
  18: "What year would you like articles from? ",
  19: ""
}
...
def create_id_to_metadata(info):
...
def ask_advanced_search():
  ...
  answer = input(ADVANCED_TO_QUESTION[request]) if request != 5 and request != 7 and request != 3 else ''
  return [request, answer if request >= 3 else int(answer)]